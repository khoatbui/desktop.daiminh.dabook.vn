              ...
              <p>
                <span>
                  <img
                    ...
                    v-bind:src="roomDetailByLang.supplierId.supplierImages.length>0?`/smimg/${roomDetailByLang.supplierId.supplierImages[0].filePath.slice(0, -3)}jpg`:'/img/defaultloading.gif'"
