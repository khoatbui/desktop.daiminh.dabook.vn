      ...
      <div class="col-12 m-0 p-0">
        <div class="card shadow-none gradient-card m-0 p-0">
          <div class="card-body m-0 p-0">
            <div
              class="row m-0 p-2 custom-bg-success text-white d-flex justify-content-between align-items-center"
            ...
            <div class="collapse" :id="`collapseCustomCar${colapsekey}`">
              <div class="row m-0 p-0">
                <div class="col-6">
                    <img class="w-100" src="/img/general/tour.jpg" alt="">
                </div>
                <div class="col-6">
                  <div class="row m-0 p-3">
                    ...
                    <div class="col-12 py-1 text-right">
                      <button
                        class="btn btn-sm custom-bg-success border-radius-100"
...
export default {
  ...
  name: "TourCustomRequestComponent",
  props: {
    quote: String,
    action: String,
    colapsekey:Number,
