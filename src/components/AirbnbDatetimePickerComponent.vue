<template>
  <div class="datepicker-trigger w-100">
    <div class="d-flex justify-content-start align-items-center p-0 m-0">
      ...
      <input type="text" id="datepicker-trigger" class="air-dateinput w-100" :class="customclass" placeholder="Select dates" :value="formatDates(date.dateOne, date.dateTwo)" />
    </div>
