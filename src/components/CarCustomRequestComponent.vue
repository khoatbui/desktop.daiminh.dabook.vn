                ...
                <div class="col-6">
                  <div class="row m-0 p-3">
                    <div class="col-6 py-1 m-0">
                      ...
                      <input class="custom-form-input" type="text" name="iname" v-model="customInfo.pickUp" />
                    </div>
                    <div class="col-6 py-1 m-0">
                      <label class="text-06 mb-1" for="iname">{{ $t('general_label_dropoff') }}</label>
                      <input class="custom-form-input" type="text" name="iname" v-model="customInfo.dropOff" />
                    </div>
                    <div class="col-12 py-1">
                      ...
                      <div class="d-flex justify-content-start align-items-center flex-wrap w-100 m-0">
                        <vs-radio class="mr-2 text-08" v-for="(car, i) in carTypeByLang" :key="'type' + i" v-model="customInfo.carType" vs-name="carType" :vs-value="car">
                          {{ car.carTypeName }}
                        </vs-radio>
                      </div>
                    </div>
                    ...
                    <div class="col-12 py-1 text-right">
                      <button class="btn btn-sm custom-bg-danger border-radius-100">{{ $t('default_contact_form_btnsendrequest') }}</button>
                    </div>
                    <div class="col-12 py-1 text-right">
                      <small class="text-06"> <font-awesome-icon icon="headset" class="text-08 text-center" />Hotline <span class="text-danger text-08 font-weight-bold">19001542</span> 24/7 </small>
                    </div>
                  </div>
                </div>
              </div>
